// This is the file for the Prim's Algorithm of Maze Genera. 
...
void generate() {  
  delay(50); //stops .1 second each frame for better visualization
  ...
  if (!path.isEmpty()) {
    ...
    // Specialized levels when the game functioned as it did originally; however, the game functions in the same way even if you change the levels requirements in the maze_generator.pde file. 
    if (level == 6)
